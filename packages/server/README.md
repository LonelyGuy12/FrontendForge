...
The `server` package is the core backend for the AsiPilot IDE. It handles real-time coordination, acts as a secure proxy to the ASI-1 Mini AI, and manages containerized terminal sessions.
